...
NODE_TLS_REJECT_UNAUTHORIZED=0";
    ...
    $settings_grid = '<div class="dc-config-section" style="margin-top:32px;">
      ...
      <div class="dc-settings-grid">
        ...
        </a>' . (\Drupal::moduleHandler()->moduleExists('dc_brand') ? '
        <a href="/admin/config/brand" class="dc-settings-card">
          <div class="dc-settings-card-icon" style="background:#fdf2f8;color:#ec4899;">
          ...
          <div>
            <div class="dc-settings-card-title">Brand</div>
            <div class="dc-settings-card-desc">Global fonts, colors, and logos</div>
          </div>
        </a>' : '') . '
      </div>
    </div>';
